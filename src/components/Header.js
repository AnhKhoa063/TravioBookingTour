...
export default function Header(props) {
    ...
    let mobileMenuAccount = (
        <>
            <li className="dropdown">
                <NavLink activeClassName='is-current' to="/register">Đăng ký</NavLink>
            </li>
        </>
    );
    ...
    let menuHeader = (
        <>
            <li className="dropdown">
                <NavLink activeClassName='is-current' to="/" exact={true}>Trang Chủ</NavLink>
            </li>
            <li className="dropdown">
                <NavLink activeClassName='is-current' to="/tour-list">Tour</NavLink>
            </li>
            <li className="dropdown">
                <NavLink activeClassName='is-current' to="/blogs">Tin Tức</NavLink>
            </li>
            <li className="dropdown">
                <NavLink activeClassName='is-current' to="/about-us">Thông Tin</NavLink>
            </li>
            <li className="dropdown">
                <NavLink activeClassName='is-current' to="/contact">Liên Lạc</NavLink>
            </li>
        </>
    )
