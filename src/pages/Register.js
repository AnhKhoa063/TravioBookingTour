    ...
    const register = (event) => {
        ...
        let registerUser = async () => {
            ...
            try {
                ...
                setOpen(true);
                createMessage('Thành công', 'Đăng ký thành công. Hãy đăng nhập để sử dụng tài khoản', 'success');
                history.push("/");
            } catch (error) {
                console.error(error);
                setOpen(true);
                createMessage('Lỗi', 'Đăng ký thất bại.', 'error');
            }
        }
                            ...
                            <form onSubmit={register} className="register-form">
                                <div className="row clearfix">
                                    <RegisterForm class="col-lg-6 col-md-6 col-sm-12 column"
                                        id="firstname" label="Họ và tên đệm" 
                                    ...
                                    />
                                    <RegisterForm class="col-lg-12 col-md-12 col-sm-12 column"
                                        id="confirmPass" label="Xác nhận mật khẩu" 
